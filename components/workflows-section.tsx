...
const carouselCards = [
  {
    ...
    title: "Understand your client needs and requirements",
    icon: ArrowRight,
    mockup: "intercom",
  },
  {
    ...
    title: "Seamless Git workflows and continuous deployment",
    icon: Plus,
    mockup: "github",
  },
  {
    ...
    title: "Develop for web, mobile, and desktop platforms",
    icon: ArrowRight,
    mockup: "mobile",
  },
  {
    ...
    title: "Convert requirements into development tasks",
    icon: ArrowRight,
    mockup: "asks",
  },
  {
    ...
    title: "50+ integrations for your development workflow",
    icon: ArrowRight,
    mockup: "integrations",
  },
  {
    ...
    title: "Connect development with design systems seamlessly",
    icon: ArrowRight,
    mockup: "figma",
  },
  {
    ...
    title: "Build and extend with our comprehensive APIs",
    icon: ArrowRight,
    mockup: "api",
  },
]
...
export function WorkflowsSection() {
  ...
  return (
    <section id="workflows" className="relative py-24 bg-white dark:bg-[#09090B] transition-colors duration-300">
        ...
        <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-8 mb-16">
          <div className="lg:max-w-xl">
            ...
            <div className="flex items-center gap-2 mb-6">
              ...
              <span className="text-sm text-gray-600 dark:text-zinc-400">Workflows and integrations</span>
              <ChevronRight className="w-4 h-4 text-gray-400 dark:text-zinc-600" />
            </div>

            {/* Heading */}
            <h2 className="text-4xl md:text-5xl font-medium text-gray-900 dark:text-white leading-[1.1]">
              Integrate with your
              <br />
              favorite tools
            </h2>
          ...
          <p className="text-zinc-400 lg:max-w-sm lg:pt-12">
            Digital Group integrates seamlessly with industry-standard tools and platforms to enhance your development workflow and keep your team aligned across all projects.
          </p>
        </div>
