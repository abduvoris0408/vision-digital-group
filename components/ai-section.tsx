      ...
      <div className="w-full flex justify-center px-6">
        <div className="w-full max-w-6xl">
          ...
          >
            ...
            <span className="text-gray-600 dark:text-zinc-400 text-sm">Modern Technology Stack</span>
          ...
          >
            <span className="text-gray-900 dark:text-white font-medium">Digital Group uses industry-leading technologies.</span> We leverage modern frameworks, cloud platforms, and development tools to deliver scalable, performant solutions.
          </motion.p>
