...
import { Check, ChevronRight, Globe, Lightbulb, Paperclip } from 'lucide-react'
			...
			<div className='w-full flex justify-center px-6'>
				<div className='w-full max-w-7xl'>
					...
					<motion.h2
						...
						className='text-3xl sm:text-4xl md:text-5xl lg:text-[56px] text-gray-900 dark:text-white max-w-3xl mb-8'
						style={{
					...
					>
						Cutting-edge development tools and frameworks
					</motion.h2>
					...
					<motion.p
						...
						className='text-gray-700 dark:text-zinc-400 max-w-md mb-8'
					>
						<span className='text-gray-900 dark:text-white font-medium'>
							Digital Group uses industry-leading technologies.
						</span>{' '}
						We leverage modern frameworks, cloud platforms, and
						development tools to deliver scalable, performant
						solutions.
					</motion.p>
					...
					<motion.button
						...
						className='px-5 py-2.5 bg-blue-600 hover:bg-blue-700 text-white rounded-lg border border-blue-700 transition-colors text-sm flex items-center gap-2 mb-16'
					>
						Learn more
						...
						>
							<div
								style={{
									...
									transform:
										'translateY(0%) rotateX(30deg) scale(1.15)',
									position: 'relative',
								}}
							>
						...
						<div className='grid grid-cols-1 md:grid-cols-2'>
							...
							<div className='border-t border-r border-b border-zinc-800/60 pt-12 pr-12 pb-16'>
								...
								<p className='text-zinc-500 text-base mb-8'>
									...
									workflows with AI assistance for routine,
									manual tasks.
								</p>
								...
								<div className='bg-zinc-900/30 border border-zinc-800/60 rounded-xl p-5'>
									...
									<div className='bg-zinc-800/40 rounded-lg p-4 ml-4'>
										...
										<p className='text-zinc-500 text-sm mb-4'>
											...
											performance problems in the mobile
											app launch flow
										</p>
							...
							<div className='border-t border-b border-zinc-800/60 pt-12 pl-12 pb-16'>
								...
								<p className='text-zinc-500 text-base mb-8'>
									Connect Sprint to your favorite tools
