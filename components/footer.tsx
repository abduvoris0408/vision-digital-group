...
export function Footer() {
  ...
  const footerLinks = {
    ...
    Connect: [
      { label: 'contact@visiondigitalgroup.com', href: 'mailto:contact@visiondigitalgroup.com' },
      ...
      <div className="max-w-6xl mx-auto">
        <div className="grid grid-cols-2 md:grid-cols-5 gap-8 mb-12 pb-12 border-b border-gray-200 dark:border-zinc-800">
          ...
          {Object.entries(footerLinks).map(([category, links]) => (
            <div key={category}>
              <h3 className="text-gray-900 dark:text-white font-semibold text-sm mb-4">{category}</h3>
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-4">
            <a href="#" className="text-xs text-gray-400 dark:text-zinc-600 hover:text-blue-500 transition-colors">Privacy Policy</a>
            <span className="text-gray-300 dark:text-zinc-700">•</span>
            <a href="#" className="text-xs text-gray-400 dark:text-zinc-600 hover:text-blue-500 transition-colors">Terms of Service</a>
          </div>
        </div>
      </div>
    </footer>
