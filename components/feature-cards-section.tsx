...
export function FeatureCardsSection() {
	return (
		<div
			id='services'
			className='relative z-20 py-40 bg-white dark:bg-[#09090B] transition-colors duration-300'
		>
			<div
				...
				style={{
					height: '20%',
					background:
						'linear-gradient(to bottom, rgba(99, 102, 241, 0.05) 0%, transparent 100%)',
				}}
			/>
					...
					<div className='flex flex-col lg:flex-row lg:items-start lg:justify-between gap-8 mb-16'>
						...
						>
							<p className='text-gray-700 dark:text-zinc-400 leading-relaxed'>
								Digital Group specializes in delivering
								comprehensive software solutions: from
								responsive, modern user interfaces to robust
								backend systems and scalable cloud
								infrastructure.{' '}
								<a
									href='#'
									className='text-gray-900 dark:text-white inline-flex items-center gap-1 hover:underline'
								>
									Learn more{' '}
						...
						{featureCards.map((card, index) => (
							...
							>
								<div
									...
									style={{
										maskImage:
											'linear-gradient(#000 70%, transparent 90%)',
										WebkitMaskImage:
											'linear-gradient(#000 70%, transparent 90%)',
									}}
								>
