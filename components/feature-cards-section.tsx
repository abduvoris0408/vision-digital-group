    ...
    illustration: (
      <div className="relative w-full h-full flex items-center justify-center overflow-hidden">
        <img
          ...
          alt="Backend engineering illustration"
...
export function FeatureCardsSection() {
  return (
    <div id="services" className="relative z-20 py-40 bg-white dark:bg-[#09090B] transition-colors duration-300">
      <div
        ...
        <div className="w-full max-w-6xl">
          ...
          <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-8 mb-16">
            <motion.h2
              ...
              className="text-3xl sm:text-4xl md:text-5xl lg:text-[56px] text-gray-900 dark:text-white max-w-md"
              style={{
            ...
            >
              <p className="text-gray-700 dark:text-zinc-400 leading-relaxed">
                Digital Group specializes in delivering comprehensive software solutions: from responsive, modern user interfaces to robust backend systems and scalable cloud infrastructure.{" "}
                <a href="#" className="text-gray-900 dark:text-white inline-flex items-center gap-1 hover:underline">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            {featureCards.map((card, index) => (
              <motion.div
                ...
                className="bg-gray-50 dark:bg-zinc-900/50 border border-gray-200 dark:border-zinc-800 hover:border-gray-300 dark:hover:border-zinc-700 transition-colors cursor-pointer group overflow-hidden relative flex flex-col justify-end"
                style={{
                  aspectRatio: "336 / 360",
                  borderRadius: "30px",
                  height: "360px",
              ...
              >
                ...
                >
                  <h3 className="text-gray-900 dark:text-white font-medium text-lg leading-tight">{card.title}</h3>
                  <div className="w-8 h-8 rounded-full border border-gray-300 dark:border-zinc-700 flex items-center justify-center text-gray-600 dark:text-zinc-500 group-hover:border-gray-400 dark:group-hover:border-zinc-500 group-hover:text-gray-900 dark:group-hover:text-zinc-300 transition-colors flex-shrink-0">
