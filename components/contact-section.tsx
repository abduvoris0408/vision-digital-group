...
export function ContactSection() {
  ...
  return (
    <section id="contact" className="relative py-40 px-6 bg-white dark:bg-[#09090B] min-h-screen flex items-center transition-colors duration-300">
      <div className="w-full max-w-6xl mx-auto">
        ...
        >
          <h1 className="text-5xl md:text-6xl font-bold text-gray-900 dark:text-white mb-6">{t('contact.title')}</h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
          ...
          >
            ...
            <p className="text-gray-700 dark:text-zinc-400">{t('contact.phone')}</p>
          </motion.div>
          ...
          >
            ...
            <p className="text-gray-700 dark:text-zinc-400">{t('contact.location')}</p>
          </motion.div>
        </div>
