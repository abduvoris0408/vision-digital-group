...
export function ProductDirectionSection() {
  return (
    <section id="projects" className="relative py-40 px-6 md:px-12 lg:px-24 bg-white dark:bg-[#09090B] transition-colors duration-300">
      {/* Gradient overlay at top */}
      <div
        className="absolute inset-x-0 top-0 pointer-events-none"
        style={{
          height: "20%",
          background: "linear-gradient(to bottom, rgba(99, 102, 241, 0.05), transparent 100%)",
        }}
      />
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="flex items-center gap-2 mb-6">
          ...
          <span className="text-zinc-400 text-sm">Project management and planning</span>
          <ChevronRight className="w-4 h-4 text-zinc-500" />
        </div>

        {/* Section heading */}
        <h2
          className="text-3xl sm:text-4xl md:text-5xl lg:text-[56px] font-medium text-zinc-900 dark:text-zinc-200 mb-8 max-w-3xl"
          style={{
        ...
        <p className="text-zinc-400 text-lg max-w-md mb-16">
          <span className="text-zinc-900 dark:text-zinc-200 font-medium">Keep your development team synchronized and focused.</span> Plan,
          manage, and deliver all project deliverables with comprehensive project management tools.
        </p>
        ...
        >
          ...
          >
            ...
            <div className="relative h-[400px]">
              ...
              <div
                className="absolute w-[1px] bg-zinc-700/50"
                style={{
                  height: "600px",
                  left: "55%",
                  top: "-100px",
                  ...
                  backgroundImage:
                    "repeating-linear-gradient(to bottom, transparent, transparent 4px, rgba(63, 63, 70, 0.5) 4px, rgba(63, 63, 70, 0.5) 8px)",
                }}
              />
              ...
              {/* Date labels */}
              <div className="absolute text-zinc-600 text-sm" style={{ left: "8%", top: "80px" }}>
                30
              </div>
              <div className="absolute text-zinc-600 text-sm" style={{ left: "18%", top: "55px" }}>
                AUG 3
              </div>
              <div className="absolute text-zinc-600 text-sm" style={{ left: "32%", top: "35px" }}>
                10
              </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2">
          ...
          <div className="border-t border-r border-b border-zinc-200 dark:border-zinc-800 pt-10 pr-10 pb-16">
            <h3 className="text-xl font-medium text-zinc-900 dark:text-zinc-200 mb-3">Manage projects end-to-end</h3>
            ...
            <div className="rounded-xl border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-900/50 p-5">
              <h4 className="text-lg font-medium text-zinc-900 dark:text-zinc-200 mb-5">Project Overview</h4>

              {/* Properties row */}
              <div className="flex items-center gap-4 mb-4">
                <span className="text-zinc-600 dark:text-zinc-500 text-sm w-20">Properties</span>
              ...
              {/* Resources row */}
              <div className="flex items-center gap-4 mb-4">
                <span className="text-zinc-600 dark:text-zinc-500 text-sm w-20">Resources</span>
                <div className="flex items-center gap-2">
                  <span className="flex items-center gap-1.5 px-2 py-1 rounded bg-zinc-800 text-zinc-300 text-xs">
              ...
              <div className="flex items-start gap-4">
                <span className="text-zinc-600 dark:text-zinc-500 text-sm w-20 pt-1">Milestones</span>
          ...
          <div className="border-t border-b border-zinc-200 dark:border-zinc-800 pt-10 pl-10 pb-16">
            <h3 className="text-xl font-medium text-zinc-900 dark:text-zinc-200 mb-3">Project updates</h3>
            <p className="text-zinc-600 dark:text-zinc-500 text-base leading-relaxed mb-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 border-b border-zinc-200 dark:border-zinc-800">
          ...
          <div className="border-r border-zinc-200 dark:border-zinc-800 pt-16 pr-10 pb-16 flex flex-col justify-center">
            <h3 className="text-2xl font-medium text-zinc-900 dark:text-zinc-200 mb-8 leading-tight">
              Ideate and specify
              <br />
              what to build next
            </h3>
            <div className="flex flex-col gap-3">
              <div className="flex items-center gap-3">
                ...
                <span className="text-zinc-900 dark:text-zinc-200 font-medium">Collaborative documents</span>
              </div>
              <div className="flex items-center gap-3">
                <div className="w-1 h-5 rounded-full bg-green-500/50" />
                <span className="text-zinc-600 dark:text-zinc-400">Inline comments</span>
              </div>
              <div className="flex items-center gap-3">
                <div className="w-1 h-5 rounded-full bg-green-500/30" />
                <span className="text-zinc-600 dark:text-zinc-500">Text-to-issue commands</span>
              </div>
            </div>
          </div>
          ...
          <div className="pt-10 pl-10 pb-16">
            <div className="rounded-xl border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-900/50 overflow-hidden">
              {/* Header */}
              <div className="flex items-center gap-2 px-4 py-3 border-b border-zinc-200 dark:border-zinc-800 text-zinc-600 dark:text-zinc-400 text-sm">
              ...
              <div className="p-5">
                ...
                <div className="mb-3 relative inline-block">
                  <span className="text-zinc-900 dark:text-zinc-200 text-lg font-medium">Collaborate on</span>
                  <span className="relative mx-1">
                    <span className="text-zinc-900 dark:text-zinc-200 text-lg font-medium bg-green-500/20 px-0.5">ideas</span>
