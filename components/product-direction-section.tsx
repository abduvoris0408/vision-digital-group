...
export function ProductDirectionSection() {
	return (
		<section
			id='projects'
			className='relative py-40 px-6 md:px-12 lg:px-24 bg-white dark:bg-[#09090B] transition-colors duration-300'
		>
			...
			<div
				...
				style={{
					height: '20%',
					background:
						'linear-gradient(to bottom, rgba(99, 102, 241, 0.05), transparent 100%)',
				}}
			/>
			...
			<div className='max-w-7xl mx-auto'>
				...
				<p className='text-zinc-400 text-lg max-w-md mb-16'>
					<span className='text-zinc-900 dark:text-zinc-200 font-medium'>
						Keep your development team synchronized and focused.
					</span>{' '}
					Plan, manage, and deliver all project deliverables with
				...
				>
					...
					>
						...
						<div className='relative h-[400px]'>
							...
							{/* Date labels */}
							<div
								className='absolute text-zinc-600 text-sm'
				...
				<div className='grid grid-cols-1 md:grid-cols-2'>
					...
					<div className='border-t border-r border-b border-zinc-200 dark:border-zinc-800 pt-10 pr-10 pb-16'>
						<h3 className='text-xl font-medium text-zinc-900 dark:text-zinc-200 mb-3'>
						...
						<div className='rounded-xl border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-900/50 p-5'>
							<h4 className='text-lg font-medium text-zinc-900 dark:text-zinc-200 mb-5'>
								Project Overview
							</h4>

							{/* Properties row */}
							<div className='flex items-center gap-4 mb-4'>
								<span className='text-zinc-600 dark:text-zinc-500 text-sm w-20'>
									Properties
								</span>
							...
							<div className='flex items-start gap-4'>
								<span className='text-zinc-600 dark:text-zinc-500 text-sm w-20 pt-1'>
									Milestones
								</span>
					...
					<div className='border-t border-b border-zinc-200 dark:border-zinc-800 pt-10 pl-10 pb-16'>
						...
						<p className='text-zinc-600 dark:text-zinc-500 text-base leading-relaxed mb-8'>
							Communicate progress and project health with
						...
						<div className='rounded-xl border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-900/50 overflow-hidden'>
							...
							<div className='p-5'>
								...
								<div className='mb-3 relative inline-block'>
									<span className='text-zinc-900 dark:text-zinc-200 text-lg font-medium'>
										Collaborate on
									</span>
									<span className='relative mx-1'>
										<span className='text-zinc-900 dark:text-zinc-200 text-lg font-medium bg-green-500/20 px-0.5'>
											ideas
										</span>
								...
								<p className='text-zinc-600 dark:text-zinc-400 text-sm leading-relaxed mb-6'>
									...
									<span className='relative inline'>
										<span className='bg-purple-500/20 px-0.5'>
											fea
										</span>
									...
									ture specs in realtime, multiplayer project
									documents. Add **style** and ##structure
