...
import { Globe, Menu, Moon, Sun, X, ChevronDown } from "lucide-react"
      ...
      <div className="w-full flex justify-center px-6 py-3">
        <div className="w-full max-w-6xl flex items-center justify-between">
          ...
          <div className="flex items-center">
            <Image
              src="/vision-digital-group-logo.png"
          ...
          <div className="hidden md:flex items-center gap-6">
            <button onClick={() => scrollToSection('hero-top')} className="text-sm text-gray-600 dark:text-zinc-400 hover:text-gray-900 dark:hover:text-white transition-colors font-medium">
              Home
            </button>
            <button onClick={() => scrollToSection('about')} className="text-sm text-gray-600 dark:text-zinc-400 hover:text-gray-900 dark:hover:text-white transition-colors font-medium">
              About Us
            </button>
                ...
                <div className="absolute top-full left-1/2 -translate-x-1/2 mt-3 w-56 bg-white dark:bg-zinc-900 border border-gray-200 dark:border-zinc-700 rounded-xl shadow-xl z-50 overflow-hidden">
                  <div className="py-1">
                    {serviceItems.map((item) => (
                      <button
                        key={item.section}
                        onClick={() => { scrollToSection(item.section); setServicesDropdownOpen(false) }}
            ...
            <button onClick={() => scrollToSection('portfolio')} className="text-sm text-gray-600 dark:text-zinc-400 hover:text-gray-900 dark:hover:text-white transition-colors font-medium">
              Case Studies
            </button>
            <button onClick={() => scrollToSection('blog')} className="text-sm text-gray-600 dark:text-zinc-400 hover:text-gray-900 dark:hover:text-white transition-colors font-medium">
              Blog
            </button>
          </div>
            ...
            <div className="relative">
              ...
              {languageMenuOpen && (
                <div className="absolute right-0 mt-2 w-32 bg-white dark:bg-zinc-900 border border-gray-200 dark:border-zinc-700 rounded-lg shadow-lg z-50">
                  ...
                  <button
                    onClick={() => { setLanguage('uz'); setLanguageMenuOpen(false) }}
                    className={`block w-full text-left px-4 py-2 text-sm transition-colors ${
                      language === 'uz'
                        ? 'bg-blue-50 dark:bg-blue-900/20 text-blue-600 dark:text-blue-400 font-medium'
                        : 'text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-zinc-800'
          ...
          <div className="md:hidden flex items-center gap-1">
            <div className="relative">
              ...
              {languageMenuOpen && (
                <div className="absolute right-0 mt-2 w-32 bg-white dark:bg-zinc-900 border border-gray-200 dark:border-zinc-700 rounded-lg shadow-lg z-50">
                  <button onClick={() => { setLanguage('en'); setLanguageMenuOpen(false) }} className={`block w-full text-left px-4 py-2 text-sm transition-colors ${language === 'en' ? 'bg-blue-50 dark:bg-blue-900/20 text-blue-600 dark:text-blue-400 font-medium' : 'text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-zinc-800'}`}>English</button>
                  <button onClick={() => { setLanguage('uz'); setLanguageMenuOpen(false) }} className={`block w-full text-left px-4 py-2 text-sm transition-colors ${language === 'uz' ? 'bg-blue-50 dark:bg-blue-900/20 text-blue-600 dark:text-blue-400 font-medium' : 'text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-zinc-800'}`}>Uzbek</button>
                </div>
              )}
            </div>
          ...
          <div className="fixed left-0 top-16 w-72 h-[calc(100vh-64px)] bg-white dark:bg-[#09090B]/95 backdrop-blur-lg border-r border-gray-200 dark:border-zinc-800 md:hidden shadow-2xl z-40 overflow-y-auto animate-in slide-in-from-left duration-300">
            <div className="flex flex-col h-full">
              <nav className="flex flex-col divide-y divide-gray-200 dark:divide-zinc-800/50">
                <button onClick={() => scrollToSection('hero-top')} className="text-sm text-gray-700 dark:text-zinc-300 hover:text-gray-900 dark:hover:text-white hover:bg-gray-100 dark:hover:bg-blue-600/10 transition-colors text-left py-4 px-6 font-medium">
                  Home
                </button>
                <button onClick={() => scrollToSection('about')} className="text-sm text-gray-700 dark:text-zinc-300 hover:text-gray-900 dark:hover:text-white hover:bg-gray-100 dark:hover:bg-blue-600/10 transition-colors text-left py-4 px-6 font-medium">
                  About Us
                </button>
                  ...
                  {mobileServicesOpen && (
                    <div className="bg-gray-50 dark:bg-zinc-900/50">
                      {serviceItems.map((item) => (
                        <button
                          key={item.section}
                          onClick={() => { scrollToSection(item.section); setMobileServicesOpen(false) }}
                ...
                <button onClick={() => scrollToSection('portfolio')} className="text-sm text-gray-700 dark:text-zinc-300 hover:text-gray-900 dark:hover:text-white hover:bg-gray-100 dark:hover:bg-blue-600/10 transition-colors text-left py-4 px-6 font-medium">
                  Case Studies
                </button>
                <button onClick={() => scrollToSection('blog')} className="text-sm text-gray-700 dark:text-zinc-300 hover:text-gray-900 dark:hover:text-white hover:bg-gray-100 dark:hover:bg-blue-600/10 transition-colors text-left py-4 px-6 font-medium">
                  Blog
                </button>
              </nav>
